...
const CreateFood = () => {
    ...
    const onSubmit = async (e) => {
        ...
        const response = await axios.post("https://feedo-wolw.onrender.com/api/food", formData, {
    ...
    const isDisabled = useMemo(() => !name.trim() || !videoFile || Number(price) < 0 || price === '', [ name, videoFile, price ]);
